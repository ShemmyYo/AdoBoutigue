"""
Django settings for gameonboard project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'l#l1&or^2mv=436f_ew593mz6d6i7-cy26n2h3x$ba%rj$tfj2')
...
WSGI_APPLICATION = 'gameonboard.wsgi.application'
...
DEFAULT_FROM_EMAIL = 'gameonboard.ecommerce@gmail.com'
